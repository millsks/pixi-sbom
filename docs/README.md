...
| [output-format.md](output-format.md) | SBOM consumers | Exactly what lands in a CycloneDX 1.6 / 1.7 or SPDX 2.3 document, field by field, and the rules behind purls, licenses, and the dependency graph |
